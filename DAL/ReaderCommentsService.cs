...
{
	/// <summary>
	/// 数据访问类:ReaderCommentsService
	/// </summary>
	public partial class ReaderCommentsService
	{
		public ReaderCommentsService()
		{}
		#region  BasicMethod
		...
		public bool Exists(string ReaderName)
		{
			...
			strSql.Append(" where ReaderName=@ReaderName ");
			SqlParameter[] parameters = {
					new SqlParameter("@ReaderName", SqlDbType.NChar,10)			};
			parameters[0].Value = ReaderName;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,BookId,ReaderName,Title,Comment,Date ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,BookId,ReaderName,Title,Comment,Date ");
			strSql.Append(" FROM ReaderComments ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
