...
{
	/// <summary>
	/// 数据访问类:TemporaryCartService
	/// </summary>
	public partial class TemporaryCartService
	{
		public TemporaryCartService()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "TemporaryCart"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from TemporaryCart");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CreateTime,BookId,UserId,Id ");
			strSql.Append(" FROM TemporaryCart ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" CreateTime,BookId,UserId,Id ");
			strSql.Append(" FROM TemporaryCart ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TemporaryCart T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TemporaryCart";
