<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Indent.aspx.cs" Inherits="OLBookstore.Web.Indent" %>
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr class="booktr" id="tr_198837">
                                                <td>
                                                    <asp:CheckBox ID="cbBook" runat="server" Checked="true" />
                                                <td id="td_book_198837" class="0">
                                                    <div class="cart_book">
                                                        <ul>
                                                            <li style="height: 91px;">
                                                                <a target="_blank" href="#/198837?ref=car" >
                                                                    <img src="userfiles/<%# GetISBNById( Eval("BookID").ToString())+".jpg" %>" width="65px" height="65px" />
                                                                </a>
                                                            </li>
                                                            <li class="cart_book_name">
                                                                <a id="a_shuming_198837" target="_blank" href="#"><%# GetNameById( Eval("BookID").ToString()) %></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </td>
                                                ...
                                                <td id="td_num_198837" class="">
                                                    ...
                                                    <asp:Label ID="lblBookAmount" runat="server" Text="0" CssClass="book_amount"></asp:Label>
